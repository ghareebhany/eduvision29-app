class ApiConstants {
  ...
  // منفذ اختياري في إضافتك المخصصة (إن أضفته). لو غير موجود يتحوّل التطبيق
  // تلقائيًا لصفحة استعادة كلمة المرور القياسية في ووردبريس أدناه.
  static const String forgotPasswordEndpoint = '/app/v1/forgot-password';

  // صفحة استعادة كلمة المرور القياسية في ووردبريس — تعمل دائمًا بدون أي تعديل
  static const String lostPasswordUrl =
      '$siteUrl/wp-login.php?action=lostpassword';
